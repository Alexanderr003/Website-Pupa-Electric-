...
const PRIVACY: Record<Locale, { h: string; p: string }[]> = {
  nl: [
    { h: 'Wie verwerkt uw gegevens', p: `${company.name}, ingeschreven bij de KvK onder nummer TODO_KVK, gevestigd in TODO_REGIO.` },
    ...
    { h: 'Uw rechten', p: 'U mag uw gegevens inzien, laten corrigeren of laten verwijderen. Een mail naar TODO_EMAIL volstaat.' },
  ],
  en: [
    { h: 'Who processes your data', p: `${company.name}, registered with the Dutch Chamber of Commerce under number TODO_KVK, based in TODO_REGIO.` },
    ...
    { h: 'Your rights', p: 'You may see, correct or delete your data. An email to TODO_EMAIL is enough.' },
  ],
  es: [
    { h: 'Quién trata sus datos', p: `${company.name}, inscrita en el registro mercantil neerlandés con el número TODO_KVK y domicilio en TODO_REGIO.` },
    ...
    { h: 'Sus derechos', p: 'Puede consultar, corregir o eliminar sus datos. Basta un correo a TODO_EMAIL.' },
  ],
};
